		...
		<div class="row">
					...
					<table class="table table-dark w-100" style="min-width: 1000px;">
						<thead style="background-color:#c49b63; height:60px">
						    ...
						    <tbody>
						        ...
						        <td class="image-prod"><img src="{{ asset('assets/images/'.$cartProduct->image.'') }}" width="100"></div></td>
    		...
    		<div class="row justify-content-end">
    			<div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                   ...
                   @else
                    <p class="text-center alert alert-success">you cannot checkout because you have no items in the cart</p>
                   @endif
                </div>
    		</div>
			</div>
